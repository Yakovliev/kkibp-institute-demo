...
const pageMeta = {
  'index.html': {
    page: 'home',
    title: `Home - ${instituteName}`,
    socialTitle: instituteNameHtml
  },
  'institute.html': {
    page: 'institute',
    title: `Institute - ${instituteName}`,
    socialTitle: `Institute - ${instituteNameHtml}`
  },
  'admissions.html': {
    page: 'admissions',
    title: `Admissions - ${instituteName}`,
    socialTitle: `Admissions - ${instituteNameHtml}`
  },
  'students.html': {
    page: 'students',
    title: `Students - ${instituteName}`,
    socialTitle: `Students - ${instituteNameHtml}`
  },
  'alumni.html': {
    page: 'alumni',
    title: `Alumni - ${instituteName}`,
    socialTitle: `Alumni - ${instituteNameHtml}`
  },
  'science.html': {
    page: 'science',
    title: `Research - ${instituteName}`,
    socialTitle: `Research - ${instituteNameHtml}`
  },
  'library.html': {
    page: 'library',
    title: `Library - ${instituteName}`,
    socialTitle: `Library - ${instituteNameHtml}`
  },
  'news.html': {
    page: 'news',
    title: `News - ${instituteName}`,
    socialTitle: `News - ${instituteNameHtml}`
  }
};

const translations = {
  'Приватний заклад "Київський кооперативний інститут бізнесу і права"': instituteName,
  'Приватний заклад &quot;Київський кооперативний інститут бізнесу і права&quot;': instituteNameHtml,
  'Київського кооперативного інституту бізнесу і права': 'of the Kyiv Cooperative Institute of Business and Law',
  'Офіційний сайт інституту: вступ, навчання, студентське життя, новини та корисні сервіси.': 'Official institute website: admissions, studies, student life, news and useful services.',
  'Логотип Приватного закладу "Київський кооперативний інститут бізнесу і права"': `${instituteName} logo`,
  'Логотип Приватного закладу &quot;Київський кооперативний інститут бізнесу і права&quot;': `${instituteNameHtml} logo`,

  'Перейти до основного вмісту': 'Skip to main content',
  'Електронна пошта та телефон': 'Email and phone',
  'Instagram інституту': 'Institute Instagram',
  'Facebook інституту': 'Institute Facebook',
  ...
  'Про Інститут': 'About the Institute',
  'Керівництво коледжу': 'College leadership',
  'Керівництво Інституту': 'Institute leadership',
  'Керівництво': 'Leadership',
  'Відділення': 'Departments',
  'Економіко-правовий факультет': 'Faculty of Economics and Law',
  ...
  'Статут Інституту': 'Institute charter',
  ...
  'Центр розвитку професійної кар’єри': 'Professional Career Development Center',
  ...
  'Коротка сторінка для базового опису Інституту, місії, історії та освітнього середовища.': 'A short page for the basic description of the Institute, its mission, history and learning environment.',
  ...
  'Сторінка для структури факультету, освітніх напрямів і контактів для подальшого наповнення.': 'A page for the faculty structure, educational areas and contacts for further content.',
  ...
  'Місце для складу кафедр, напрямів роботи та методичних матеріалів.': 'A place for department staff, areas of work and methodological materials.',
  ...
  'Адреса, телефони, електронна пошта та службові контакти Інституту.': 'Address, phone numbers, email and service contacts of the Institute.',
  ...
  'Напрями розвитку, стратегічні орієнтири та принципи діяльності Інституту.': 'Development directions, strategic guidelines and principles of Institute activity.',
  ...
  'Положення, правила, регламенти та інші внутрішні документи Інституту.': 'Policies, rules, regulations and other internal Institute documents.',
  ...
  'Поточні плани роботи Інституту та ключові організаційні пріоритети.': 'Current Institute work plans and key organizational priorities.',
  ...
  'Звітні матеріали про роботу Інституту, результати та виконані завдання.': 'Reporting materials on Institute work, results and completed tasks.',
  ...
  'Ініціативи Інституту, пов’язані зі сталим розвитком, відповідальністю та спільнотами.': 'Institute initiatives related to sustainable development, responsibility and communities.',
  ...
  'Керівництво відповідає за стратегічний розвиток Інституту, якість освітнього процесу та організацію навчально-методичної роботи.': 'The leadership team is responsible for Institute strategic development, educational quality and academic-methodological work.',
  ...
  'Фаховий молодший бакалавр': 'Professional Junior Bachelor',
  'Бакалавр': 'Bachelor',
  'Магістр': 'Master',
  ...
  'Освітні програми фахового молодшого бакалавра для вступників після базової або повної загальної середньої освіти.': 'Professional Junior Bachelor programs for applicants after basic or complete general secondary education.',
  'Освітні програми першого рівня вищої освіти, умови вступу та майбутні матеріали для абітурієнтів.': 'First-cycle higher education programs, admission terms and future materials for applicants.',
  'Освітні програми другого рівня вищої освіти, вступні вимоги та матеріали для майбутніх магістрів.': 'Second-cycle higher education programs, admission requirements and materials for future master students.',
  ...
  'Рада молодих вчених': 'Young Scientists Council',
  ...
  'Документи ККІБП з питань академічної доброчесності': 'KKIBP documents on academic integrity',
  ...
  'Сторінка для складу ради, планів роботи, ініціатив і матеріалів молодих науковців.': 'A page for council membership, work plans, initiatives and materials for young researchers.',
  ...
  'Внутрішні документи, положення та процедури ККІБП щодо академічної доброчесності.': 'Internal KKIBP documents, policies and procedures on academic integrity.',
...
const patchHead = (html, file) => {
  ...
  return html
    ...
    .replace(/<meta property="og:site_name" content="[^"]+">/, `<meta property="og:site_name" content="${instituteNameHtml}">`)
    .replace(/<meta property="og:title" content="[^"]+">/, `<meta property="og:title" content="${meta.socialTitle}">`)
    .replace(/<meta property="og:description" content="[^"]+">/, '<meta property="og:description" content="Official institute website: admissions, studies, student life, news and useful services.">')
    .replace(/<meta property="og:url" content="[^"]+">/, `<meta property="og:url" content="${socialUrl}">`)
    .replace(/<meta property="og:image:alt" content="[^"]+">/, `<meta property="og:image:alt" content="${instituteNameHtml} logo">`)
    ...
    .replace(/<meta name="twitter:description" content="[^"]+">/, '<meta name="twitter:description" content="Official institute website: admissions, studies, student life, news and useful services.">')
    .replace(/<meta name="twitter:image:alt" content="[^"]+">/, `<meta name="twitter:image:alt" content="${instituteNameHtml} logo">`)
